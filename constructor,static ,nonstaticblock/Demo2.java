...
class Demo2
{
	public static void main(String args[])
	{
		...
		/*Exception in thread "main" java.lang.NullPointerException: Cannot invoke "Student.printDetails()" because "<local3>[<local4>]" is null
        at Demo2.main(Demo2.java:41)*/
		//s1[size].printDetails();
	}
}
/*
Array of objects:=>
